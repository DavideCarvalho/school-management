...
export default function FeaturesHero() {
  ...
  return (
    <Flex bg="white" p={20} w="auto" justifyContent="center" alignItems="center">
      <Box px={8} py={20} mx="auto" bg={useColorModeValue("white", "gray.800")} shadow="dark-lg">
        <Box textAlign={{ lg: "center" }}>
          ...
          >
            Garanta total transparência da sua escola com pais e alunos
          </chakra.p>
        </Box>
        <SimpleGrid
        ...
        >
          ...
          >
            Organize your customers to bring meaningful and comparative insights across your
            dashboards.
          </Feature>
          <Feature
            color="brand"
          ...
          >
            Improve your conversion rates by monitoring exactly what’s going on while your customers
            are in trial.
          </Feature>
          ...
          >
            Merge external data with your metrics for deeper insights in to your customers and your
            business.
          </Feature>
          ...
          >
            Want your metrics in other services? Extend and integrate to our every part of your
            business.
          </Feature>
